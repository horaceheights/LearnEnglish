...
- Normalized option images must fill the shared 3:2 media viewport without visible letterboxing. If a safe crop would remove a head, face, hand, foot, or teaching action, reframe or outpaint the source instead of accepting empty side space or distorted content.
