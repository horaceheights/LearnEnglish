...
- Every lesson option-media viewport uses that same 3:2 shape on one-, two-, three-, and four-card slides. Cards may scale uniformly to fit the viewport, but their proportions, padding, and framing rules must not change with the option count.
...
- 2026-08-24: The parents-talking clip received a reviewed, parents-only 3:2 action crop so its played scale matches the option card while preserving both heads, faces, and conversational hand gestures.
