...
- Authored card order is part of the lesson contract. Cards must follow an intentional learning story, conversational sequence, or real-world chronology; runtime delivery may randomize answer positions but must never shuffle the cards themselves.
- Teach language in the order a learner would naturally use it. A greeting comes before a name introduction or information exchange, and a goodbye or other closing comes after that exchange; never place a closing before the interaction it closes.
...
- 2026-09-01: Authored lesson order standardized on coherent conversational, narrative, or real-world chronology. Answer positions may randomize, but cards may not; greetings precede introductions and exchanges, closings follow them, review stations remain internally coherent, and every mission card advances the story.
