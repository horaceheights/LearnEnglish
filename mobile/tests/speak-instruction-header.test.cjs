...
assert.equal(speakCards.length, 417, 'The Speak inventory includes four rebuilt Unit 2, Unit 3, Unit 4, Unit 5 and Unit 6 mission gates each, plus the 3.3 current-action exchange.');
