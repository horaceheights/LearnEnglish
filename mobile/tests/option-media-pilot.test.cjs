...
assert.match(cardView, /useThreeByTwoOptionMediaPilot[\s\S]*?aspectRatio:\s*3\s*\/\s*2/);
assert.match(cardView, /resizeMode=\{useThreeByTwoOptionMediaPilot\s*\?\s*'cover'\s*:\s*'contain'\}/);
