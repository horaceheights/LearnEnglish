...
assert.doesNotMatch(
  normalizerSource,
  /SOLID_SIDE_FILL_COLOR|force_original_aspect_ratio=decrease|color=c=|gblur|boxblur/,
  'Normalization must never bake solid or blurred padding into a lesson clip.',
);
