...
const styles = StyleSheet.create({
  container: { gap: 14, marginTop: 14 },
  phrase: { color: '#24333a', fontSize: 22, fontWeight: '900', lineHeight: 28, textAlign: 'center' },
  statusRow: { alignItems: 'center', flexDirection: 'row', justifyContent: 'center', minHeight: 44 },
  statusDot: { borderRadius: 6, height: 11, marginRight: 10, width: 11 },
  wave: { alignItems: 'center', flexDirection: 'row', gap: 3, height: 32, marginRight: 10 },
  waveBar: { borderRadius: 3, width: 4 },
  message: { flexShrink: 1, fontSize: 15, fontWeight: '800' },
