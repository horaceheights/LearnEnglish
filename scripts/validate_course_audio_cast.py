...
ASSIGNMENT_GROUPS: dict[str, list[tuple[str, str, str]]] = {
    ...
    "lesson-3-1-greetings-and-names": [
        ...
        ("audio_speaker", "luis", "L2 L4 L5 R2 R4 N3 N5 S3 S4 U2 U3 U6"),
    ...
    "lesson-3-5-countries-and-nationalities": [
        ...
        ("audio_speaker", "luis", "L7 L9 R7 S3 S4 U8"),
    ...
    "lesson-3-6-professions": [
        ...
        ("answer_audio_speaker", "luis", "R8 U6"),
    ],
    ...
    "lesson-3-9-unit-3-review": [
        ("audio_speaker", "male-character", "L1 L2 R1 R3 R4 N1 N2 S1 U1"),
    ...
    "lesson-7-9-complete-a1-review": [
        ...
        ("audio_speaker", "male-character", "U8"),
