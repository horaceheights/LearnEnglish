...
const childrenSiblings = lesson({
  ...
  cards: [
    ...
    recognize('Sisters', 'sisters', [image('brothers', assets.brothers, 'Brothers'), image('sisters', assets.sisters, 'Sisters'), image('baby', assets.baby, 'A baby'), image('family', assets.family, 'A family')]),
    recognize('Brothers', 'brothers', [image('sisters', assets.sisters, 'Sisters'), image('brother', assets.brother, 'A brother'), image('family', assets.family, 'A family'), image('brothers', assets.brothers, 'Brothers')]),
    ...
    listen('Children', 'children', [image('children', assets.children, ''), image('brothers', assets.brothers, '')]),
    listen('They are brothers.', 'brothers', [image('sisters', assets.sisters, ''), image('brothers', assets.brothers, '')]),
    listen('They are sisters.', 'sisters', [image('sisters', assets.sisters, ''), image('children', assets.children, '')]),
    listen('They are a family.', 'family', [image('family', assets.family, ''), image('babies', assets.babies, ''), image('brothers', assets.brothers, ''), image('children', assets.children, '')]),
...
const isAreNot = lesson({
  ...
  cards: [
    ...
    learn('They are not sitting.', 'parents-not-sitting', assets.parentsTalking),
    ...
    recognize('They are not sitting.', 'parents-talking', [image('grandparents-sitting', assets.grandparentsSitting, 'They are sitting.'), image('parents-talking', assets.parentsTalking, 'They are not sitting.')]),
    ...
    describe(assets.motherCooking, 'She is not working.', 'not-working', [['cooking', 'She is cooking.'], ['not-working', 'She is not working.']]),
    ...
    listen('She is not drinking.', 'girl-writing', [image('girlDrinking', assets.girlDrinking, ''), image('girl-writing', assets.girlWriting, ''), image('girl-reading', assets.girlReading, ''), image('girl-walking', assets.girlWalking, '')]),
    listen('They are not sitting.', 'grandparents-talking', [image('grandparents-sitting', assets.grandparentsSitting, ''), image('grandparents-talking', assets.grandparentsTalking, ''), image('children-playing', assets.childrenPlaying, ''), image('parents', assets.parents, '')]),
    ...
    speak('They are not sitting.', 'parents-not-sitting', assets.parentsTalking),
    ...
    use('They are ___ sitting.', assets.parentsTalking, 'They are not sitting.', 'not', [['is', 'is'], ['not', 'not']]),
    use('The father ___ cooking.', assets.motherCooking, 'The father is not cooking.', 'not', [['not', 'is not'], ['are', 'are']]),
    use('The children ___ studying.', assets.childrenStudying, 'The children are studying.', 'are', [['is', 'is'], ['are', 'are']]),
...
const whoLesson = lesson({
  ...
  cards: [
    ...
    recognize('Who is he?', 'father', [image('father', assets.father, 'He is the father.'), image('grandfather', assets.grandfather, 'He is the grandfather.')]),
    recognize('Who is she?', 'mother', [image('grandmother', assets.grandmother, 'She is the grandmother.'), image('mother', assets.mother, 'She is the mother.')]),
    recognize('Who are they?', 'parents', [image('parents', assets.parents, 'They are the parents.'), image('grandparents', assets.grandparents, 'They are the grandparents.')]),
    recognize('Who are they?', 'children', [image('adults', assets.adults, 'They are adults.'), image('children', assets.children, 'They are children.')]),
    ...
    listen('Who are they? They are the brothers.', 'brothers', [image('brothers', assets.brothers, ''), image('sisters', assets.sisters, ''), image('parents', assets.parents, ''), image('babies', assets.babies, '')]),
...
const reviewLesson = lesson({
  ...
  cards: [
    ...
    listen('They are not studying.', 'children-playing', [image('children-studying', assets.childrenStudying, ''), image('children-playing', assets.childrenPlaying, ''), image('parents-talking', assets.parentsTalking, ''), image('pair-running', assets.pairRunning, '')]),
    ...
    use('They are ___ sitting.', assets.parentsTalking, 'They are not sitting.', 'not', [['not', 'not'], ['is', 'is']]),
...
const missionLesson = lesson({
  ...
  cards: [
    ...
    listen('They are the sisters.', 'sisters', [image('brothers', assets.brothers, ''), image('sisters', assets.sisters, ''), image('parents', assets.parents, ''), image('babies', assets.babies, '')]),
    listen('The grandparents are not sleeping.', 'grandparents-talking', [image('grandparents-sitting', assets.grandparentsSitting, ''), image('grandparents-talking', assets.grandparentsTalking, ''), image('girl-sleeping', assets.girlSleeping, ''), image('parents', assets.parents, '')]),
