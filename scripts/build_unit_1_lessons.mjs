...
const isAreNot = lesson({
  ...
  cards: [
    ...
    listen('They are not sitting.', 'grandparents-talking', [image('grandparents-sitting', assets.grandparentsSitting, ''), image('grandparents-talking', assets.grandparentsTalking, '')]),
